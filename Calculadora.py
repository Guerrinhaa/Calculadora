...
# Criando a função para inserir valores no display
...
# Criando Botões
b_1 = Button(frame_corpo, command=limpar_display, text="C", width=11, height=2, bg=cor4, font=('Ivy', 13, 'bold'), relief=RAISED, overrelief=RIDGE)
b_1.place(x=0, y=0)
